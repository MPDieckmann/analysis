...
function htmlescapespe(input: string): string {
...
class ViewScreen {
  ...
  private _createLine(line: AnalysisLine, lineNumber: string) {
  ...
  private _editWord(this: {
    lines: AnalysisTable,
    record: AnalysisRecord,
    origTd: HTMLElement,
    analysisTd: HTMLElement,
    transTd: HTMLElement
  }) {
